...
function HomePage() {
  return (
    <>
      <Head>
        <title>Beer Explorer v21</title>

        <meta
          name="description"
          content="Discover the World of Brews with Beer Explorer v21: Unveiling Intriguing Beer Profiles, Rich Histories, and Exciting Locations to Satisfy Your Thirst for Knowledge and Adventure."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover the World of Brews with Beer Explorer v21: Unveiling Intriguing Beer Profiles, Rich Histories, and Exciting Locations to Satisfy Your Thirst for Knowledge and Adventure.`}
            </Text>
